...
def prepare_headers():
    ...
    if not foundry_api_key:
        raise ValueError("FOUNDRY_API_KEY is not set in the environment or .env file. Go on the page to edit your module and find it there, just above the Save button.")
